      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="font-orbitron text-2xl font-bold text-white mb-4">
              Игры<span className="text-red-500"> Маклая</span>
            </h2>
          ...
          {/* Content */}
          <div>
            <h3 className="font-orbitron text-white font-semibold mb-4">Контент</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="font-orbitron text-white font-semibold mb-4">Портал</h3>
            <ul className="space-y-2">
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-red-500/20">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="font-space-mono text-gray-400 text-sm">2025 GameVerse. Все права защищены.</p>
